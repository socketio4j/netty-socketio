...
public class DistributedRedissonJsClientInteropTest extends AbstractDistributedJsClientInteropTest {
    ...
    public void setupCluster() throws Exception {
        ...
        String url = "redis://" + REDIS.getHost() + ":" + REDIS.getRedisPort();

        org.redisson.config.Config rConfig1 = DistributedClusterIntegrationSupport.redisConfig(url);
        rConfig1.setCodec(new org.redisson.codec.SerializationCodec());
        redisClient1 = Redisson.create(rConfig1);

        org.redisson.config.Config rConfig2 = DistributedClusterIntegrationSupport.redisConfig(url);
        rConfig2.setCodec(new org.redisson.codec.SerializationCodec());
        redisClient2 = Redisson.create(rConfig2);
    ...
    public void teardownCluster() {
        TestResourceCleanup.runAll("Redisson distributed interop cleanup",
