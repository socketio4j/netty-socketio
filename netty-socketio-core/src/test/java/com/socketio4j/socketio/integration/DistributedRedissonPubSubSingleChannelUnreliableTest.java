...
public class DistributedRedissonPubSubSingleChannelUnreliableTest extends DistributedCommonTest {
    ...
    public void setup() throws Exception {
        ...
        cfg1.setStoreFactory(new RedisStoreFactory(
                redisClient1, new RedisPubSubEventStore.Builder(redisClient1).eventStoreMode(EventStoreMode.SINGLE_CHANNEL).build()
        ));
        ...
        cfg2.setStoreFactory(new RedisStoreFactory(
                redisClient2, new RedisPubSubEventStore.Builder(redisClient2).eventStoreMode(EventStoreMode.SINGLE_CHANNEL).build()
        ));
