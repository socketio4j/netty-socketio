...
public class DistributedRedissonPubSubSingleChannelUnreliableTest extends DistributedCommonTest {
    ...
    public void setup() throws Exception {
        ...
        cfg1.setStoreFactory(new RedissonStoreFactory(
                redisClient1, new RedissonEventStore.Builder(redisClient1).eventStoreMode(EventStoreMode.SINGLE_CHANNEL).build()
        ));
        ...
        cfg2.setStoreFactory(new RedissonStoreFactory(
                redisClient2, new RedissonEventStore.Builder(redisClient2).eventStoreMode(EventStoreMode.SINGLE_CHANNEL).build()
        ));
