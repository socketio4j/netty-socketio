...
public class HazelcastPubSubRingBufferEventStore extends AbstractEventStore {
    ...
    public HazelcastPubSubRingBufferEventStore(
        ...
        super(nodeId, eventStoreMode, EventStoreMode.MULTI_CHANNEL,
    ...
    public void publish0(EventType type, EventMessage msg) {
        ...
        ITopic<EventMessage> topic = activePubTopics.computeIfAbsent(
                type, k -> hazelcastPub.getReliableTopic(channelName(k)));
    ...
    public <T extends EventMessage> void subscribe0(EventType type, final EventListener<T> listener, Class<T> clazz) {
        ...
        ITopic<T> topic = hazelcastSub.getReliableTopic(channelName(type));
