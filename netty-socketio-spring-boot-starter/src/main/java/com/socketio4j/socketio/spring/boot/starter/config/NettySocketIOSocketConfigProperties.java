...
import static com.socketio4j.socketio.spring.boot.starter.config.NettySocketIOSocketConfigProperties.PREFIX;

/**
 * Socket configuration properties for Netty Socket.IO server.
