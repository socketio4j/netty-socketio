...
title: Changelog
nav_order: 10
description: "Version history and release notes for Netty-SocketIO"
permalink: /changelog/
---

# Changelog

This page contains the complete version history and release notes for Netty-SocketIO.

## Netty-SocketIO (com.socketio4j) Releases

Refer to: [Maven Central](https://mvnrepository.com/artifact/com.socketio4j/netty-socketio-core)
...
## Original netty-socketio (com.corundumstudio.socketio) Releases

Refer to: [Maven Central](https://mvnrepository.com/artifact/com.corundumstudio.socketio/netty-socketio)
