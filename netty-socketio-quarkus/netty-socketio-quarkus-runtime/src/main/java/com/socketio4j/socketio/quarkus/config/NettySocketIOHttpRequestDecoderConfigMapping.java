 ...
 *
 * @see com.socketio4j.socketio.HttpRequestDecoderConfiguration
 */
...
public interface NettySocketIOHttpRequestDecoderConfigMapping {
     ...
     * @see com.socketio4j.socketio.HttpRequestDecoderConfiguration#getMaxInitialLineLength()
     */
    @WithDefault("4096")
     ...
     * @see com.socketio4j.socketio.HttpRequestDecoderConfiguration#getMaxHeaderSize()
     */
    @WithDefault("8192")
    int maxHeaderSize();
     ...
     * @see com.socketio4j.socketio.HttpRequestDecoderConfiguration#getMaxChunkSize()
     */
    @WithDefault("8192")
    int maxChunkSize();
}
