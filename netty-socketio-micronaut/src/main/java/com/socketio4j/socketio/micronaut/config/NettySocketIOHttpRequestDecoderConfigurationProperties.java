...
import static com.socketio4j.socketio.micronaut.config.NettySocketIOHttpRequestDecoderConfigurationProperties.PREFIX;

/**
 * HTTP request decoder configuration properties for Netty Socket.IO server in Micronaut.
